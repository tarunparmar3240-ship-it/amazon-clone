...
const Footer = () => {
  return (
    <div className="w-full">
      ...
      <div class="bg-[#131A22] text-white py-8 px-4">
        <div class="max-w-3xl mx-auto grid grid-cols-4 gap-x-8 gap-y-4 mb-8 pr-60">
          <div>
            <a
              href="#"
              class="hover:underline font-bold text-[12px] text-gray-200 block leading-tight"
            >
              AbeBooks
            </a>
            <span class="text-gray-400 text-[11px] block leading-tight">
              Books, art
              <br />& collectibles
            </span>
          </div>
        ...
        <div class="text-center text-[11px] text-gray-300 space-y-1">
